// товар добавляется в корзину по клику на кнопку купить в карточки товара, корзина проверяет дубликаты и не отображает их, а просто
// увеличивает общую цену и кол-во по одному отдельно взятому товару если он выбран более одного раза
